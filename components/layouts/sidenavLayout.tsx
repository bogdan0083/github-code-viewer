...
const SidenavLayout = ({ children, sideNavContent }: LayoutProps) => {
  ...
  const wrapperClassName =
    "flex flex-col flex-grow md:flex-row md:h-[calc(100vh-var(--header-height))]";
  const sidenavWrapperClassName = clsx({
    "flex-col flex-shrink-0 md:w-3/12 md:h-full overflow-auto hidden md:flex":
      true,
    "md:border-r border-gray-300 dark:border-gray-800":
